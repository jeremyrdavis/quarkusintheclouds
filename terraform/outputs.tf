...
# EventBus outputs
output "eventbus-namespace_name" {
  description = "Name of the Service Bus namespace"
  value       = module.eventbus.eventbus_namespace_name
}

output "eventbus-queue_name" {
  description = "Name of the Service Bus queue"
  value       = module.eventbus.eventbus_queue_name
}

output "eventbus-topic_name" {
  description = "Name of the Service Bus topic"
  value       = module.eventbus.eventbus_topic_name
}

output "eventbus-connection_string" {
